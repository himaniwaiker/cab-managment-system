			...
			<div class="container">
				<nav class="navbar navbar-default yamm">
				    <div class="container-fluid">
						...
						<center><form class="form-inline" role="search">
		                            <div class="form-1">
		                          <center> 
		                          <br>
		                          <br> 
		                          	<img src="images/happy.jpg" alt="Linda">
		                          	<br>
		                          	<h1>Thank You...for Booking</h1>
		                            <h3>Your Cab Booked Successfully</h3>
		                          <h2> Wishing you a safe and joyful journey ahead</h2>
		                           </center> </div>
								</form></center></div><!-- end section-title -->
